...
public:
   ...
   virtual int getLength() const = 0;
    ...
    /** Gets the position of a given entry in the list.
     @param entry  The entry to get a position for.
     @return The integer representing the position of the entry. */
   ...
   virtual bool remove(int position) = 0;
    ...
    /** Removes a given entry from this list. Calls getPosition to get 
