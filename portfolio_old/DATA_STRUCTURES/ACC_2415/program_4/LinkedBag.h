...
public:
   ...
   bool remove(); // new remove prototype
   void clear();
...
#include "Node.h"
#include <cstddef>
#include <time.h> // for seeding with srand()
...
//**********************************************************************
//* NEW ADD METHOD: Adds a new element to the END of the list.         *
//**********************************************************************
template <class ItemType>
bool LinkedBag<ItemType>::add(const ItemType& newEntry)
{
    ...
    else
    {
        ...
        int count=0;
        while((nextNodePtr->getNext() != nullptr) && (count<itemCount))
        {
            nextNodePtr=nextNodePtr->getNext();
            count++;
        }
        nextNodePtr->setNext(new Node<ItemType>(newEntry));
    }
    itemCount++;
    return true;
} // end add
...
//*****************************************************************************************
//* NEW REMOVE METHOD: removes a random entry from the bag.                               *
//*****************************************************************************************
template<class ItemType>
bool LinkedBag<ItemType>::remove()
{
    ...
    if (canRemoveItem)
    {
        ...
        tmpPtr->setItem(headPtr->getItem());
