...
void LinkedList::moveNode(int position1, int position2)
{
	...
	// make the new last node point to null:
	node3->next = NULL;	
} // end of moveNode method.
...
void loop()
{
	...
	do
	{
		...
		***********************************************************************/
		...
		list4.removeDupes();
		cout << endl << "List 4 (list 3 with duplicates removed): " << endl;
		list4.displayList();
		printBarrier();
